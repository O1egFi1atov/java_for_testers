...
/* Ниже альтернативный способ описания структуры объектов, а именно пример использования нотации record вместо class, стало доступно в версиях JAVA 17 и новее */
//
